...
using LiteralObject = std::variant<std::monostate, bool, NumericValue, std::pair<NumericValue, NumericValue>, std::string, NilType>;
...
constexpr bool IsNumericPair(const LiteralObject& literal) noexcept { return std::holds_alternative<std::pair<NumericValue, NumericValue>>(literal); }
