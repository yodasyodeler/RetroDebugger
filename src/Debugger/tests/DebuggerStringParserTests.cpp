...
TEST(DebuggerStringParser, ParseNumber_) {
    ...
    EXPECT_TRUE(Rdb::ParseNumber(number_1, numberOut));
    EXPECT_EQ(numberOut, 1);

    EXPECT_TRUE(Rdb::ParseNumber(number_9567, numberOut));
...
TEST(DebuggerStringParser, DebugStringParser_ParseNumberSingleInvalidNum) {
    ...
    EXPECT_FALSE(Rdb::ParseNumber(number_float, numberOut));

    const std::string number_negative("-5");
    EXPECT_FALSE(Rdb::ParseNumber(number_negative, numberOut));

    const std::string number_notNum("abc");
    EXPECT_FALSE(Rdb::ParseNumber(number_notNum, numberOut));

    const std::string number_startAsNum("1abc");
    EXPECT_FALSE(Rdb::ParseNumber(number_startAsNum, numberOut));

    const std::string number_endAsNum("abc1");
    EXPECT_FALSE(Rdb::ParseNumber(number_endAsNum, numberOut));

    const std::string number_empty;
    EXPECT_FALSE(Rdb::ParseNumber(number_empty, numberOut));

    const std::string number_numSpaceNum("1 2");
    EXPECT_FALSE(Rdb::ParseNumber(number_numSpaceNum, numberOut));
}
...
TEST(DebuggerStringParser, DebugStringParser_ParseNumberRange) {
    ...
    EXPECT_TRUE(Rdb::ParseList(number_range, numbers));
    EXPECT_EQ(numbers[0], 1);
    EXPECT_EQ(numbers[1], 2);

    EXPECT_TRUE(Rdb::ParseList(number_rangeLeadingZeros, numbers));
    EXPECT_EQ(numbers[0], 1);
    EXPECT_EQ(numbers[1], 2);

    EXPECT_TRUE(Rdb::ParseList(number_rangeLeadingZerossecond, numbers));
    EXPECT_EQ(numbers[0], 1);
    EXPECT_EQ(numbers[1], 2);

    EXPECT_TRUE(Rdb::ParseList(number_rangeWrongDirection, numbers));
...
TEST(DebuggerStringParser, DebugStringParser_ParseListInvalidRanges) {
    ...
    EXPECT_TRUE(!Rdb::ParseList(number_rangeCharFirst, number));
    EXPECT_TRUE(!Rdb::ParseList(number_rangeCharSecond, number));
    EXPECT_TRUE(!Rdb::ParseList(number_rangeNegativeRange, number));
    EXPECT_TRUE(!Rdb::ParseList(number_rangeOneNum, number));
    EXPECT_TRUE(!Rdb::ParseList(number_rangeEmptyRange, number));
}
...
TEST(DebuggerStringParser, DebugStringParser_ParseNumberDifferentNotations) {
    ...
    EXPECT_TRUE(Rdb::ParseNumber(number_hex, number));
    EXPECT_EQ(number, 90);
    EXPECT_TRUE(Rdb::ParseNumber(number_binary, number));
    EXPECT_EQ(number, 10);
    EXPECT_TRUE(Rdb::ParseList(number_rangeMismatch, numbers));
...
TEST(DebuggerStringParser, DebugStringParser_ParseComplexLists) {
    ...
    EXPECT_TRUE(Rdb::ParseList(number_list1, numbers));
    EXPECT_EQ(numbers.size(), 3);
    EXPECT_EQ(numbers[0], 0);
    EXPECT_EQ(numbers[1], 1);
    EXPECT_EQ(numbers[2], 2);

    EXPECT_TRUE(Rdb::ParseList(number_list2, numbers));
    ...
    EXPECT_TRUE(Rdb::ParseList(number_list3, numbers));
...
TEST(DebuggerStringParser, DISABLED_DebugStringParser_ParseComplexSubLists) { // TODO: enable if negative numbers to remove items from lists becomes supported
    ...
    EXPECT_TRUE(Rdb::ParseList(number_list0, numbers));
...
TEST(DebuggerStringParser, ParseNumberPair_happyPath) {
    ...
    ASSERT_TRUE(Rdb::ParseNumberPair(intergerValues, num1, num2, ":"));
    EXPECT_EQ(num1, 123);
    EXPECT_EQ(num2, 456);

    static constexpr auto hexAndBinaryValues = "0xFF:0b10100101";
    ASSERT_TRUE(Rdb::ParseNumberPair(hexAndBinaryValues, num1, num2, ":"));
    EXPECT_EQ(num1, 0xFF);
    EXPECT_EQ(num2, 0b10100101);

    static constexpr auto valuesWithlongSeparator = "505I'm A Separator1234";
    ASSERT_TRUE(Rdb::ParseNumberPair(valuesWithlongSeparator, num1, num2, "I'm A Separator"));
    EXPECT_EQ(num1, 505);
    EXPECT_EQ(num2, 1234);
}
...
TEST(DebuggerStringParser, ParseNumberPair_invalidNumbers) {
    ...
    EXPECT_FALSE(Rdb::ParseNumberPair(invalidPair_noNumbers, num1, num2, ":"));

    static constexpr auto invalidPair_noSecondNumber = "123:";
    EXPECT_FALSE(Rdb::ParseNumberPair(invalidPair_noSecondNumber, num1, num2, ":"));

    static constexpr auto invalidPair_noFirstNumber = ":456";
    EXPECT_FALSE(Rdb::ParseNumberPair(invalidPair_noFirstNumber, num1, num2, ":"));

    static constexpr auto invalidPair_invalidFirstNumber = "abc:456";
    EXPECT_FALSE(Rdb::ParseNumberPair(invalidPair_invalidFirstNumber, num1, num2, ":"));

    static constexpr auto invalidPair_invalidSecondNumber = "123:def";
    EXPECT_FALSE(Rdb::ParseNumberPair(invalidPair_invalidSecondNumber, num1, num2, ":"));
}
...
TEST(DebuggerStringParser, ParseNumberPair_invalidSeperator) {
    ...
    EXPECT_FALSE(Rdb::ParseNumberPair(invalidPair_missingSeperator, num1, num2, ":"));

    static constexpr auto invalidPair_differentSeperator = ":456";
    EXPECT_FALSE(Rdb::ParseNumberPair(invalidPair_differentSeperator, num1, num2, ":"));

    static constexpr auto invalidPair_twoSeperators = "0xabc::456";
    EXPECT_FALSE(Rdb::ParseNumberPair(invalidPair_twoSeperators, num1, num2, ":"));

    static constexpr auto invalidPair_multipleSeperators_seperatorAtMiddle = "123:0xd:0xef";
    EXPECT_FALSE(Rdb::ParseNumberPair(invalidPair_multipleSeperators_seperatorAtMiddle, num1, num2, ":"));

    static constexpr auto invalidPair_multipleSeperators_seperatorAtEnd = "123:0xdef:";
    EXPECT_FALSE(Rdb::ParseNumberPair(invalidPair_multipleSeperators_seperatorAtEnd, num1, num2, ":"));
}